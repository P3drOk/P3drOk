...
`Configuração → Encoder → Zero absoluto → Declarar esta posição como
referência` (atrás de um cadeado, porque desloca a área útil inteira) faz
o que a máquina faz ao ligar: declara
